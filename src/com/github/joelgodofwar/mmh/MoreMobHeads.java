...
import com.github.joelgodofwar.mmh.handlers.EventHandler_1_20_R1_2;
import com.github.joelgodofwar.mmh.handlers.EventHandler_1_20_R2_2;
	...
	public void onEnable(){
		...
		try{
			...
			if( version.isBetween("1.20", "1.20.4") ){
				eventHandler = new EventHandler_1_20_R1_2(this, headManager);
				getServer().getPluginManager().registerEvents((EventHandler_1_20_R1_2) eventHandler, this);
				...
				eventHandler = new EventHandler_1_20_R2_2(this, headManager);
				getServer().getPluginManager().registerEvents((EventHandler_1_20_R2_2) eventHandler, this);
				Command_1_20_R2 commandHandler = new Command_1_20_R2(this, headManager, eventHandler.getGiveHeadCommand(), eventHandler.getViewHeadsCommand(), eventHandler);
				Objects.requireNonNull(getCommand("mmh")).setExecutor(commandHandler);
				Objects.requireNonNull(getCommand("mmh")).setTabCompleter(commandHandler);
			}else{
