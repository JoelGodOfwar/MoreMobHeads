...
public class ChanceCommand {
            ...
            switch (subCommand) {
                        ...
                        if (!fileName.equals("player.json") && !fileName.equals("named.json")) {
                            ...
                            if (!fileDefaultChances.containsKey(fileName)) {
                                try {
                                    ...
                                    CoreUtils.warn("Failed to read defaultChance from " + fileName + ": " + e.getMessage());
                ...
                case "import": {
                    ...
                    for (String fileName : files.keySet()) {
                        ...
                        if (!jsonFile.exists()) {
                            CoreUtils.warn("File not found: " + fileName);
                            continue;
                        }
                        ...
                        if (fileName.equals("player.json")) {
                            ...
                            if (playerChance < 0.0 || playerChance > 100.0) {
                                CoreUtils.warn("Invalid chance value " + playerChance + " for " + fileName + "; skipping");
                                continue;
                            }
                            try {
                                ...
                                CoreUtils.warn("Failed to update " + fileName + ": " + e.getMessage());
                            }
                            ...
                            if (namedChance < 0.0 || namedChance > 100.0) {
                                CoreUtils.warn("Invalid chance value " + namedChance + " for " + fileName + "; skipping");
                                continue;
                            }
                            try {
                            ...
                            if (defaultChance < 0.0 || defaultChance > 100.0) {
                                CoreUtils.warn("Invalid defaultChance value " + defaultChance + " for " + fileName + "; using 100.0");
                                defaultChance = 100.0;
                            }
                    ...
                    try {
                        ...
                        CoreUtils.warn("Failed to move " + chanceFile.getName() + " to backup: " + e.getMessage());
                ...
                case "set":
                    ...
                    if (langName.equals("player")) {
                        ...
                        try {
                            ...
                            CoreUtils.warn("Failed to update player.json for chance " + chance + ": " + e.getMessage());
                        ...
                        try {
                            ...
                            CoreUtils.warn("Failed to update named.json for chance " + chance + ": " + e.getMessage());
                        ...
                        try {
                            ...
                            CoreUtils.warn("Failed to update defaultChance in " + fileName + ": " + e.getMessage());
                        ...
                        try {
                            ...
                            CoreUtils.warn("Failed to update " + jsonFile.getName() + " for " + langName + ": " + e.getMessage());
        ...
        if ("flat".equalsIgnoreCase(structure)) {
            ...
            for (int i = 0; i < heads.length(); i++) {
                ...
                if (chances.has(langName)) {
                    ...
                    if (chance < 0.0 || chance > 100.0) {
                        CoreUtils.warn("Invalid chance value " + chance + " for " + langName + " in " + fileName + "; skipping");
                        continue;
                    }
                    head.put("chance", chance);
                }
        ...
        for (String key : node.keySet()) {
            ...
            if (value instanceof JSONObject) {
                ...
                if (jsonObject.has("langName") && chances.has(fullKey)) {
                    ...
                    if (chance < 0.0 || chance > 100.0) {
                        CoreUtils.warn("Invalid chance value " + chance + " for " + fullKey + " in " + fileName + "; skipping");
                        continue;
                    }
    ...
    private boolean updateNestedChance(JSONObject node, String langName, double chance) {
        ...
        for (int i = 0; i < parts.length - 1; i++) {
            ...
            if (current.has(part)) {
                ...
                if (next instanceof JSONObject) {
                    ...
                    CoreUtils.warn("Invalid structure at " + part + " in " + langName);
                    return false;
                }
            } else {
                CoreUtils.warn("Key not found: " + part + " in " + langName);
                return false;
            }
        }
        ...
        CoreUtils.warn("Could not find " + finalKey + " in " + langName);
        return false;
    }
}