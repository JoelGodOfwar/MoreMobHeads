...
import com.github.joelgodofwar.mmh.common.collections.ExpireHashMap;
...
public class DetailedErrorReporter implements ErrorReporter {
	...
	public void reportDetailed(Object sender, Report report) {
		...
		// And plugin
		if (plugin != null) {
			writer.println("Version: " + mmh.getName() + " v" + mmh.getDescription().getVersion());
			String jarfilename = mmh.getjarfilename();
		...
		FileConfiguration config = mmh.getConfig();
